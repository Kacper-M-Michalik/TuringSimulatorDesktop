...
namespace TuringSimulatorDesktop.UI
{
    ...
    public class Button : IVisualElement, IClickable, IPollable
    {
        ...
        public Button(ActionGroup group)
        {
            Background = new Icon();
            Group = group;
        ...
        public Button(int width, int height, ActionGroup group)
        {
            Background = new Icon();
        ...
        public Button(int width, int height, UILookupKey BaseKey, ActionGroup group) : this(width, height, group)
        {
            BaseTexture = GlobalRenderingData.TextureLookup[BaseKey];
        }

        public Button(int width, int height, UILookupKey BaseKey, UILookupKey HighlightKey, ActionGroup group) : this(width, height, group)
        {
            BaseTexture = GlobalRenderingData.TextureLookup[BaseKey];
